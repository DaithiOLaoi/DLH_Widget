...
import com.example.dlhwidget.DLHWidget;
import com.example.dlhwidget.R;
...
//        RemoteViews view = new RemoteViews(getPackageName(), R.layout.dlhwidget);
//        view.setTextViewText(R.id.text1, newWindSpd.split("|")[0]);
//        view.setTextViewText(R.id.text1, newWindSpd.split("|")[1]);
//        ComponentName theWidget = new ComponentName(this, DLHWidget.class);
...
//        manager.updateAppWidget(theWidget, view);
    ...
    public class getWindUpdate extends AsyncTask<Void, Void, Void> {
...
//                gustSpd_wid = gustSpd.split(" \\(")[0];
                ...
                ComponentName theWidget = new ComponentName(context, DLHWidget.class);
       ...
       //return windSpd_wid + "|" + gustSpd_wid;
